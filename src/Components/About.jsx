      ...
      <section id="about">
        <div className="about-section">
          <div className="skills-section">
            ...
            <p>
              Agile, SCRUM, pair programming, software development lifecycle
              (SDL), technical communication
            </p>
          </div>
          <div className="experience-section">
            ...
            <ul>
              <li>
                Built dynamic full-stack web applications using JavaScript,
              ...
              <li>
                ...
                reviews—sharpening my ability to write clean code and
